...
// Геттеры и сеттеры - свойства-асессоры - функции(методы) для присвоения и получения значения. Используются как функции для записи/чтения св-в.
...
// У свойств-асессоров дескрипторы отличаются от обычных св-в - нет writable и value, зато есть get и set.
...
// Геттеры и сеттеры используются как функции записи/чтения св-в объекта.
