...
console.log(user99.constructor);            // Output: [Function: User]
console.log(user99.__proto__.constructor);  // Output: [Function: User]         (не забываем, что если св-ва нет в объекте, оно ищется дальше в прототипе)
...
console.log(rabbit4.eats);        // Output: true (delete не продолжает поиск в прототипе, если не находит св-во в объекте)
