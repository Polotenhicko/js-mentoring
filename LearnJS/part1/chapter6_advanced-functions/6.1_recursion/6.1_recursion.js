...
// Работая с рекурсией необходимо учитывать объем стека. Для проверки удобно пользоваться конструкцией try...catch
let i = 0;
...
try {
  ...
  console.log(`Stack size for empty func is ${i}`);     // Output: 'Stack size for empty func is 13954'
}
