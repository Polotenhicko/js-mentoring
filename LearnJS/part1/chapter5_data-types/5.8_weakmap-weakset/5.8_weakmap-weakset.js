...
// В том числе, для кеширования - запоминания результата, чтобы не выполнять выражение больше одного раза
...
/*
* Методы и свойства WeakSet:
*
* `new WeakSet()`           – создаёт коллекцию.
* `WeakSet.add(value)`      – записывает значение value.
* `WeakSet.has(value)`      – возвращает true, если value присутствует в коллекции, иначе false.
* `WeakSet.delete(value)`   – удаляет элемент по ключу key.
*/
// ---------------------------------------------------------------------------------------------------------------------
